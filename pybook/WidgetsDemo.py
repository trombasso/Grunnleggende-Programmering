...
class WidgetsDemo:
    def __init__(self):
        ...
        rbYellow = Radiobutton(
            frame1, text="Yellow", bg="yellow", variable=self.v2, value=2, command=self.processRadiobutton
        )
        ...
        message = Message(frame2, text="Demo")
...
#     def __init__(self):
#         window = tk.Tk()
#         btOK = tk.Button(window, text="OK", fg="red", command=self.processOK)
#         btCancel = tk.Button(window, text="Cancel", fg="yellow", command=self.processCancel)
#         btOK.pack()
#         btCancel.pack()
